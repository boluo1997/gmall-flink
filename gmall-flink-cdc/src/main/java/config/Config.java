...
public class Config {
    ...
    public static final String MYSQL_CDC1_HOSTNAME = "mysql.cdc1.hostname";
    public static final String MYSQL_CDC1_PORT = "mysql.cdc1.port";
    public static final String MYSQL_CDC1_USERNAME = "mysql.cdc1.username";
